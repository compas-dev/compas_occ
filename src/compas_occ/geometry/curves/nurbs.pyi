...
class NurbsCurve(BaseNurbsCurve):
    ...
    @classmethod
    def from_arc(cls, arc, degree, pointcount=None) -> 'NurbsCurve': ...

    @classmethod
    def from_circle(cls, circle: Circle) -> 'NurbsCurve': ...

    @classmethod
    def from_ellipse(cls, ellipse) -> 'NurbsCurve': ...
    ...
    def divide_by_count(self, count) -> List['NurbsCurve']: ...

    def divide_by_length(self, length) -> List['NurbsCurve']: ...
