...
.. code-block:: text
    ...
    BSplineCurve
    ------------
    Poles: [Point(0.000, 0.000, 0.000), Point(0.194, 0.505, -0.029), Point(0.793, 1.425, 0.037), Point(1.946, 2.197, 0.312), Point(3.109, 2.053, 0.692), Point(4.130, 1.482, 1.013), Point(5.171, 0.737, 1.259), Point(6.257, -0.016, 1.369), Point(7.462, -0.606, 1.266), Point(8.836, -0.676, 0.783), Point(9.652, -0.331, 0.293), Point(10.000, 0.000, 0.000)]
